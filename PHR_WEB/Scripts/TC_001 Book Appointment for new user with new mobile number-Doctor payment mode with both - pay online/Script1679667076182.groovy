...
String patient_name = CustomKeywords.'phrweb_common_keys.GetValues.getExcelValues'('patient', 2, 1)
...
String drname = CustomKeywords.'phrweb_common_keys.GetValues.getExcelValues'('numbers', 2, 4)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_home_page/welcome_to_nh_popup_title'),30)


WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_home_page/i_am_a_new_user_button'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_home_page/i_am_a_new_user_button'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_home_page/header_doctor_search_field'), 30)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_home_page/searched_doctor_1st_from_the_list'), 30)
WebUI.click(findTestObject('Object Repository/phr_elements_home_page/searched_doctor_1st_from_the_list'))

WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_home_page/what_ur_looking_for'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_home_page/hospital_visit_button'), 30)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/add_new_patient_popup_header'),30)


WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_name_field'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_name_field'))
WebUI.setText(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_name_field'),patient_name)



WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_dob_field'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_dob_field'))
sleep(1000)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_dob_field'))
sleep(1000)
WebUI.setText(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_dob_field'),patient_dob)




WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_gender_male_radio_button'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/patient_gender_male_radio_button'))




WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/email_field'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/email_field'))
WebUI.setText(findTestObject('Object Repository/phr_elements_add_new_patient_popup/email_field'),patient_email)


WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/pincode_field'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/pincode_field'))
WebUI.setText(findTestObject('Object Repository/phr_elements_add_new_patient_popup/pincode_field'),patient_pincode)
sleep(1000)

WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/email_field'))

sleep(1000)
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_add_new_patient_popup/book_appointment_button'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_add_new_patient_popup/book_appointment_button'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/both_booking_confirmation_page/booking_confirmed_title'),30)
WebUI.verifyElementPresent(findTestObject('Object Repository/both_booking_confirmation_page/pay_online_button'), 30)
...
WebUI.scrollToElement(findTestObject('Object Repository/recording_objects/Page_Narayana Health - Payment Link - LUBwz_272e9e/div_Netbanking  All Indian banks'),30)
...
WebUI.scrollToElement(findTestObject('Object Repository/recording_objects/Page_Narayana Health - Payment Link - LUBwz_272e9e/div_Yes'),30)
...
WebUI.click(findTestObject('Object Repository/recording_objects/Page_Narayana Health - Payment Link - LUBwz_272e9e/button_Pay Now'))
  ...
  WebUI.navigateToUrl(loginportalurl+"ocaapp/appointments")
