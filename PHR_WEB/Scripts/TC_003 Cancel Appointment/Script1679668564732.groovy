...
String loginmobile = CustomKeywords.'phrweb_common_keys.GetValues.getExcelValues'('numbers', 4, 3)
...
String patient_name = CustomKeywords.'phrweb_common_keys.GetValues.getExcelValues'('patient', 4, 1)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_consultation_list_page/more_icon_cancel_appointment_option'),30)
WebUI.click(findTestObject('Object Repository/phr_elements_consultation_list_page/more_icon_cancel_appointment_option'))

WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_consultation_list_page/cancel_appointment_popup_header'),30)


WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_consultation_list_page/others_option_on_cancel_appointment_popup'),30)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_consultation_list_page/tell_us_more_field_on_cancel_appointment_popup'),30)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_consultation_list_page/submit_button_on_cancel_appointment_popup'),30)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/phr_elements_consultation_list_page/cancelled_appointment_status'),30)
